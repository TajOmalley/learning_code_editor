    ...
    const renderStars = (count:number)=>{
        return Array(5).fill(0).map((_ ,i)=>(
            <Star key={i} size={14} className={
                i < count ? "fill-yellow-400 text-yellow-400" : "text-grey-300"
            }/>
        ))
    }
            ...
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                {
                    step === "select" ? (
                        ...
                        <DialogHeader>
                            <DialogTitle className="text-2xl font-bold text-[#212121] flex items-center gap-2">
                                <Plus size={24} className="text-[#212121]"/>
                                Select a Template
                            </DialogTitle>
                        ...
                        <div className="flex flex-col gap-6 py-4">
                            ...
                            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                                ...
                                <Button className="bg-[#000000] hover:bg-[#212121]" onClick={handleContinue}>
                    ...
                    <div className="flex flex-col gap-6 py-4">
                        ...
                        <div className="p-4 shadhow-[0_0_0_1px#E93F3f,0_8px_20px_rgba(233,63,63,0.15)] rounded=lg border">
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            ...
                            <Button
                                className="bg-[#000000] hover bg-[#212121]"
